...
def store_conversations_to_csv(conversations, file_path):
    """Stores filtered Dashboard conversations into a CSV file"""
...
def main_function():
    """Main function to extract, filter, and save Dashboard conversations"""
    ...
    if conversations:
        ...
        print(f"Dashboard Conversations: {len(dashboard_conversations)}")

        store_conversations_to_csv(dashboard_conversations, '1-21-25-combined_dashboard_output-2.csv')
    else:
