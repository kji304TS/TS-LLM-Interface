...
def store_conversations_to_csv(conversations, file_path):
    """Stores filtered Swaps conversations into a CSV file"""
    ...
    with open(file_path, mode='w', newline='', encoding='utf-8') as file:
        ...
        for conversation in conversations:
            ...
            swaps_issue = conversation.get('Swaps issue', 'None')
            ...
            writer.writerow({
                ...
                'Swaps issue': swaps_issue
            })


def main_function():
    """Main function to extract, filter, and save Swaps conversations"""
    ...
    if conversations:
        ...
        print(f"Swaps Conversations: {len(swaps_conversations)}")

        store_conversations_to_csv(swaps_conversations, '1-21-25-combined_swaps_output-2.csv')
    else:
